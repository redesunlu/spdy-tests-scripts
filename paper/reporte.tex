...
\vspace*{2\baselineskip}
En el 50\% de los casos \textsc{spdy} super'o a \textsc{https} y a \textsc{http}. Es una cifra importante dado que el 93\% de los sitios en Internet usan \textsc{http} como se puede ver en el gr'afico de la Figura \ref{httpvsthhps} \cite[run 15/11/2013]{httpArchive}.
\begin{figure*}[ht]
  	\centering
	\includegraphics[scale=0.93]{exp2_1}
